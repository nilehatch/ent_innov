...
To structure your observational studies, consider the following questions \autocite{plattner2013empathy}:
...
-   Proprietary sources like Frost and Sullivan, Forrester, and others offer detailed reports but can be costly. These are often more suitable for established businesses or those with access to corporate subscriptions.
-   For students, university libraries often provide access to a wide range of proprietary data sources. For example, BYU students can access a comprehensive collection through the Harold B. Lee Library. Here is an [index of databases](https://guides.lib.byu.edu/emba506hatch/) useful for entrepreneurial innovation.
...
## When Enough is Enough: Determining the Size of Your Data Mountain
...
## Conclusion: The Essence of Exploratory Research
